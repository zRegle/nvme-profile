...
parser.add_argument('-p', '--pci_address', help="nvme device pcie address", required=True)
parser.add_argument('-s', '--spdk_path', help="path to spdk repo", required=True)
parser.add_argument('-f', '--fio_path', help="path to fio path", required=True)
args = parser.parse_args()

# fio parameters
read_ratio = [50, 75, 90, 95, 99, 100]
